...
if [ "$platform" = "windows" ]; then
	...
	scons platform=windows tools=no target=template_release custom_modules="../spine_godot,../godoterrorhandler" $mono_module --jobs=$cpus
	scons platform=windows tools=no target=template_debug custom_modules="../spine_godot,../godoterrorhandler" $mono_module --jobs=$cpus
	...
	scons platform=macos tools=no target=template_release arch=x86_64 custom_modules="../spine_godot,../godoterrorhandler" $mono_module --jobs=$cpus
	scons platform=macos tools=no target=template_debug arch=x86_64 custom_modules="../spine_godot,../godoterrorhandler" $mono_module --jobs=$cpus
	scons platform=macos tools=no target=template_release arch=arm64 custom_modules="../spine_godot,../godoterrorhandler" $mono_module --jobs=$cpus
	scons platform=macos tools=no target=template_debug arch=arm64 custom_modules="../spine_godot,../godoterrorhandler" $mono_module --jobs=$cpus
	...
	scons platform=linuxbsd tools=no target=template_release bits=64 custom_modules="../spine_godot,../godoterrorhandler" $mono_module --jobs=$cpus
	scons platform=linuxbsd tools=no target=template_debug bits=64 custom_modules="../spine_godot,../godoterrorhandler" $mono_module --jobs=$cpus
	...
	scons p=ios tools=no target=template_release arch=arm64 custom_modules="../spine_godot,../godoterrorhandler" --jobs=$cpus
	scons p=ios tools=no target=template_debug arch=arm64 custom_modules="../spine_godot,../godoterrorhandler" --jobs=$cpus
	scons p=ios tools=no target=template_release arch=arm64 ios_simulator=yes custom_modules="../spine_godot,../godoterrorhandler" --jobs=$cpus
	scons p=ios tools=no target=template_release arch=x86_64 ios_simulator=yes custom_modules="../spine_godot,../godoterrorhandler" --jobs=$cpus
	scons p=ios tools=no target=template_debug arch=arm64 ios_simulator=yes custom_modules="../spine_godot,../godoterrorhandler" --jobs=$cpus
	scons p=ios tools=no target=template_debug arch=x86_64 ios_simulator=yes custom_modules="../spine_godot,../godoterrorhandler" --jobs=$cpus
	...
	scons platform=web tools=no target=template_release custom_modules="../spine_godot,../godoterrorhandler" --jobs=$cpus
	scons platform=web tools=no target=template_debug custom_modules="../spine_godot,../godoterrorhandler" --jobs=$cpus
	...
	scons platform=android target=template_release android_arch=armv7 custom_modules="../spine_godot,../godoterrorhandler" --jobs=$cpus
	scons platform=android target=template_debug android_arch=armv7 custom_modules="../spine_godot,../godoterrorhandler" --jobs=$cpus
	scons platform=android target=template_release android_arch=arm64v8 custom_modules="../spine_godot,../godoterrorhandler" --jobs=$cpus
	scons platform=android target=template_debug android_arch=arm64v8 custom_modules="../spine_godot,../godoterrorhandler" --jobs=$cpus
